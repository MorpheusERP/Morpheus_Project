...
<body>
    ...
    <script>
        ...
        document.getElementById('razaoSocial').addEventListener('keypress', function(e) {
            if (e.key === 'Enter') {
                e.preventDefault();
                buscarFornecedores();
            }
        ...
        document.getElementById('nomeFantasia').addEventListener('keypress', function(e) {
            if (e.key === 'Enter') {
                e.preventDefault();
                buscarFornecedores();
            }
        ...
        function exibirResultados(fornecedores) {
            ...
            console.log('Exibindo resultados:', fornecedores, 'Quantidade:', fornecedores.length);
            ...
            // Adicionar cada fornecedor na tabela
